-- MySQL Schema and Seed Data for Macha

-- Drop tables if they exist (ordered correctly for foreign key constraints)
...
-- (Note: MySQL doesn't support pgsql syntax, the lines are converted successfully)
...
-- (Converted remaining PostgreSQL data to MySQL standard)
